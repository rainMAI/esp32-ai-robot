...
public:
    ...
    void UpdateAudioActivity();  // 更新音频活动时间，防止电源管理禁用音频
    ...
    void ResetDecoder();
    void PushTaskToEncodeQueue(AudioTaskType type, std::vector<int16_t>&& pcm, uint32_t timestamp = 0xFFFFFFFF, bool wait = true);
